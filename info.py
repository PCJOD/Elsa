...
NOR_IMG = environ.get('NOR_IMG', "https://graph.org/file/b3328a63370c3c5302e5c.jpg")
...
REQ_CHANNEL = environ.get("REQ_CHANNEL", -1001819700169)
REQ_CHANNEL = int(REQ_CHANNEL) if REQ_CHANNEL and id_pattern.search(REQ_CHANNEL) else -1001819700169
...
S_GROUP = environ.get('S_GROUP',"https://t.me/pcmoviegroup")
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.me/newmalayalammovies2024")
#Must change this link to work redirect (FILE_FORWORD)
FILE_FORWARD = environ.get('FILE_FORWARD',"https://t.me/newmalayalammovies2024")
MSG_ALRT = environ.get('MSG_ALRT', '𝑪𝑯𝑬𝑪𝑲 & 𝑻𝑹𝒀 𝑨𝑳𝑳 𝑴𝒀 𝑭𝑬𝑨𝑻𝑼𝑹𝑬𝑺')
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', 0))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'pcmoviegroup')
