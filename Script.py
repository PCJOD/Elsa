...
𝙷𝙴𝚁𝙴 𝙸𝚂 𝚃𝙷𝙴 𝙷𝙴𝙻𝙿 𝙵𝙾𝚁 𝙼𝚈 𝙲𝙾𝙼𝙼𝙰𝙽𝙳𝚂.</b>"""
    ...
    ABOUT_TXT = """<b>✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {}
✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: <a href=https://t.me/cometomovechannels>𝙽𝚎𝚠 𝙼𝚘𝚟𝚒𝚎𝚜</a>
✯ 𝙳𝙴𝚅: <a href= 𝙿𝙲
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝙷𝙴𝚁𝙾𝙺𝚄
✯ 𝙱𝚄𝙸𝙻𝙳 𝚂𝚃𝙰𝚃𝚄𝚂: v2.0.1 [ 𝙱𝙴𝚃𝙰 ]</b>"""
    ...
    SOURCE_TXT = """<b>NOTE:</b>
<b>- ᴛʜɪꜱ ʙᴏᴛ ɪꜱ ᴀɴ PRIVATE ᴘʀᴏᴊᴇᴄᴛ. 
- 𝐌𝐨𝐯𝐢𝐞 𝐠𝐫𝐨𝐮𝐩 - 𝙲𝙻𝙸𝙲𝙺 𝐌𝐨𝐯𝐢𝐞 𝐠𝐫𝐨𝐮𝐩 𝙱𝚄𝚃𝚃𝙾𝙽</b>
<b>DEVS:</b>
- <a href=https://t.me/newmalayalammovies2024>𝙽𝚎𝚠 𝙼𝚘𝚟𝚒𝚎𝚜</a>"""
